...
from aistack.schemas import GPUDeviceStatus, GPUDevicesStatus
from aistack.schemas.workers import GPUCoreInfo, MemoryInfo, GPUNetworkInfo
...
class Runtime(GPUDetector):
    """
    Detect GPUs using aistack-runtime.
    """
