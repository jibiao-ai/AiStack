...
from aistack.policies.event_recorder.recorder import EventCollector, EventLevelEnum
...
from aistack.utils.gpu import (
    abbreviate_worker_gpu_indexes,
    group_gpu_ids_by_worker,
    group_gpu_indexes_by_gpu_type_and_worker,
)
from aistack.policies.base import Allocatable, ModelInstanceScheduleCandidate
            ...
            if self._gpu_count and self._gpu_count != world_size:
                ...
                if should_skip_gpu_count_check(model):
                    logger.warning(
                        ...
                        f"to AISTACK_SKIP_GPU_COUNT_CHECK. Keeping the selected gpu count."
                    )
                    return
                ...
                raise ValueError(
                    ...
                    f"If the mismatch is intentional, add AISTACK_SKIP_GPU_COUNT_CHECK=1 to the model's environment variables to bypass this check and keep the selected gpu count."
                )
