...
from aistack.cloud_providers.common import factory, get_provider_api_endpoint
from aistack.routes.proxy import proxy_to
...
async def proxy_cluster_provider_api(
    ...
    if response.status_code in [401, 403, 404]:
        ...
        response.headers.append("X-AiStack-Original-Status", str(original_status))
    return response
