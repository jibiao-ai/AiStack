...
from aistack.schemas import Worker
...
from aistack.schemas.models import BackendEnum, Model, BackendSourceEnum
...
# — its baseline is the in-code aistack-runner catalog. Reopened narrowly for
