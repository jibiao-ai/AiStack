...
from aistack.schemas.inference_backend import is_custom_backend
...
from aistack.schemas.cache_services import CacheService
from aistack.schemas.clusters import Cluster
from aistack.schemas.gpu_instance_types import GPUInstanceType
from aistack.schemas.workers import GPUDeviceStatus, Worker
from aistack.utils.version import version_in_range
...
from aistack.server.deps import (
    CurrentUserDep,
    ListParamsDep,
    SessionDep,
    TenantContextDep,
...
from aistack.schemas.principals import platform_principal_id
from aistack.server.services import (
    ModelService,
    WorkerService,
    revoke_model_access_cache,
)
from aistack.server.scaling_scheduler import compute_desired_replicas
from aistack.server.cache_provider_catalog import get_cache_provider
from aistack.server.lora_adapters_discovery import list_adapters_for_base
...
from aistack.utils.gpu import parse_gpu_id
from aistack.routes.model_common import (
...
from aistack.utils.lora_model_source import lora_route_name_for
        ...
        unsupported_params = [
            (
                ...
                (
                    ...
                    "automatically allocated by AiStack."
                ),
            ),
            (
                ["api-key"],
    ...
    *,
    ...
    if detail is None or not detail.memory:
        raise BadRequestException(
            ...
            "aistack-operator has not finished backfilling the type. Retry once "
