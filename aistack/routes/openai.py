...
from aistack.http_proxy.load_balancer import LoadBalancer
from aistack.routes.model_common import build_category_conditions
...
from aistack.schemas.principals import Principal, platform_principal_id
from aistack.schemas.workers import Worker
from aistack.routes.model_routes import (
    _model_route_grant_conditions,
    _my_model_visibility_sql,
)
from aistack.server.db import async_session
from aistack.server.deps import SessionDep, CurrentUserDep, TenantContextDep
...
def mutate_request(
    ...
    if (
        ...
        and body_json
        and model.env
        and model.env.get("AISTACK_APPLY_QWEN3_RERANKER_TEMPLATES", False)
    ):
