...
from aistack.api.exceptions import error_responses, openai_api_error_responses
...
from aistack.api.tenant import require_org_role
from aistack.schemas.principals import OrgRole
...
_EXTENDED_API_IN_SCHEMA = os.getenv("AISTACK_EXTENDED_API_DOCS", "").lower() in (
    "1",
    "true",
    "yes",
)
