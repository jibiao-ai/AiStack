...
from aistack.server.worker_status_buffer import (
...
from aistack.server.worker_allocated_cache import (
...
from aistack.server.services import WorkerService
from aistack.cloud_providers.common import key_bytes_to_openssh_pem
...
def get_existing_worker(
    ...
    if worker_in.labels and worker_in.labels.get("aistack.existence-check"):
