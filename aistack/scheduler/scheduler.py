...
from aistack.policies.scorers.placement_scorer import PlacementScorer
from aistack.policies.scorers.model_file_locality_scorer import (
    ModelFileLocalityScorer,
)
from aistack.policies.scorers.score_chain import CandidateScoreChain
from aistack.config.config import Config, get_global_config
from aistack.policies.base import (
    ModelInstanceScheduleCandidate,
    WorkerFilterChain,
)
from aistack.policies.candidate_selectors import (
...
from aistack.policies.candidate_selectors.custom_backend_resource_fit_selector import (
    CustomBackendResourceFitSelector,
)
from aistack.policies.utils import ListMessageBuilder, should_skip_gpu_count_check
from aistack.policies.worker_filters.backend_framework_filter import (
    BackendFrameworkFilter,
)
from aistack.policies.worker_filters.label_matching_filter import LabelMatchingFilter
from aistack.policies.worker_filters.gpu_matching_filter import GPUMatchingFilter
from aistack.policies.worker_filters.local_path_filter import LocalPathFilter
from aistack.policies.worker_filters.cluster_filter import ClusterFilter
from aistack.scheduler.model_registry import detect_model_type
from aistack.scheduler.meta_registry import get_model_meta
from aistack.scheduler.queue import AsyncUniqueQueue
from aistack.policies.worker_filters.status_filter import StatusFilter
from aistack import envs
from aistack.schemas.inference_backend import is_built_in_backend
...
from aistack.schemas.model_files import ModelFileStateEnum
from aistack.server.bus import EventType
from aistack.server.db import async_session
from aistack.scheduler.calculator import (
    GPUOffloadEnum,
...
from aistack.utils.gpu import group_gpu_ids_by_worker
from aistack.utils.hub import has_diffusers_model_index
from aistack.utils.math import largest_power_of_2_leq
from aistack.utils.model_source import get_draft_model_source
from aistack.scheduler.calculator import get_pretrained_config_with_workers
...
async def find_candidate(
    ...
    :param config: AiStack configuration.
