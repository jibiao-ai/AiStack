...
class VersionConfig(BaseModel):
    ...
    Attributes:
        ...
        built_in_frameworks: Only built-in backend will return this field, sourced from aistack-runner configuration. (Optional)
...
def is_built_in_backend_custom_version(
    ...
    outside aistack-runner catalogs: explicit model image, or an inference
