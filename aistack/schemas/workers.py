...
from aistack.utils.network import is_offline
    ...
    def compute_state(self):
        ...
        if is_not_ready_flag:
            ...
            self.state_message = (
                ...
                "Otherwise, please <a href='https://docs.aistack.ai/latest/troubleshooting/#view-aistack-logs'>check the worker logs</a>."
            )
            return
        ...
        if self.unreachable:
            ...
            msg = (
                ...
                "<a href='https://docs.aistack.ai/latest/installation/requirements/#port-requirements'>documentation</a>"
            )
