...
# to agree: ``aistack reset-admin-password`` submits a generated password
...
def get_key_pair(key: str) -> Tuple[str, str]:
    ...
    Scenarios:
    1. Standard format key: "aistack_{access_key}_{secret_key}"
...
AUTH_CACHE_HEADER = "x-aistack-auth-cache"
