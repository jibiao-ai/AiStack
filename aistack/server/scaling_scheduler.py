...
from aistack.schemas.models import Model, ScalingSchedule
from aistack.server.db import async_session
from aistack.server.services import ModelService
from aistack.utils.rollup_tz import resolve_rollup_tz
...
def compute_desired_replicas(
    ...
    (``AISTACK_TIMEZONE``, shared with usage rollups) — see
