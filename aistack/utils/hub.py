...
from aistack.schemas import ModelFile
...
from aistack.utils.cache import is_cached, load_cache, save_cache
...
def auth_check(
    ...
    if model.source == SourceEnum.HUGGING_FACE:
        ...
        try:
            ...
            raise Exception(
                "Access to the model is restricted. Please set a valid Huggingface token with proper permissions in the AiStack server configuration."
            )
