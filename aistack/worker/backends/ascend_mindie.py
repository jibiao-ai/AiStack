...
from aistack.worker.backends.base import InferenceServer, is_ascend_310p
...
class AscendMindIEServer(InferenceServer):
    """
    Containerized Ascend MindIE inference server backend using aistack-runtime.
    ...
    def _start(self):  # noqa: C901
        ...
        # https://github.com/aistack/runner/blob/main/pack/cann/Dockerfile#L273
...
## Cache Envs Configured by AiStack
...
## Override Envs Configured by AiStack
...
## Execute the binary preprocessed by AiStack Runner if exists,
