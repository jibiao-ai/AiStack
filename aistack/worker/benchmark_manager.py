...
from aistack.logging import RedirectStdoutStderr
...
from aistack.worker.schemas.benchmark_runner import (
...
class BenchmarkManager:
    ...
    def _launch_benchmark(
        ...
        setproctitle.setproctitle(f"aistack_benchmark_{benchmark.id}")
        add_signal_handlers()
