...
from aistack.policies.utils import compute_worker_allocated
...
class MetricExporter(Collector):
    ...
    def start(self):
        try:
            ...
            app = FastAPI(
                title="AiStack Worker Metrics Exporter",
...
class RawCollector(Collector):
    ...
    def collect(self):
        # passthrough raw metrics from runtime and add aistack related labels.
