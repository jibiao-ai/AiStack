...
|-----------------------------------------------------------------------|-----------------------------------------------------------------|-------------------------------------------------------------------------|
| `--backend` `{cann,corex,cuda,dtk,hggc,maca,musa,neuware,rocm}`       | (empty)                                                         | Filter aistack/runner images by backend name                           |
| `--backend-version` `BACKEND_VERSION`                                 | (empty)                                                         | Filter aistack/runner images by exact backend version                  |
| `--backend-version-prefix` `BACKEND_VERSION_PREFIX`                   | (empty)                                                         | Filter aistack/runner images by backend version prefix                 |
| `--backend-variant` `BACKEND_VARIANT`                                 | (empty)                                                         | Filter aistack/runner images by backend variant                        |
| `--service` `{voxbox,vllm,mindie,sglang}`                             | (empty)                                                         | Filter aistack/runner images by service name                           |
| `--service-version` `SERVICE_VERSION`                                 | (empty)                                                         | Filter aistack/runner images by exact service version                  |
| `--service-version-prefix` `SERVICE_VERSION_PREFIX`                   | (empty)                                                         | Filter aistack/runner images by service version prefix                 |
