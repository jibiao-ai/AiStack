...
MaxKB can integrate with AiStack to leverage locally deployed **LLMs, embedding models, and reranking models** for building knowledge-based AI assistants.
...
1. In the AiStack sidebar, open the **Routes** page.
...
```
Base URL: http://your-aistack-url/v1
...
## Integrating AiStack into MaxKB
...
* **Base Model**: Must match the model name deployed in AiStack.
* **API URL**: `http://your-aistack-url/v1`
* **API Key**: The API key created in AiStack.
...
The assistant can now answer questions based on the connected knowledge base and models deployed on AiStack.
