...
Please refer to the [**Model Deployment**](../user-guide/model-deployment-management.md#deploy-model) section in the AiStack documentation to complete model deployment.

## API Access Info

1. Log in to the AiStack Web UI
...
3. Fill in the information provided by AiStack as prompted:
...
After completing these steps, OpenClaw will use AiStack to invoke the corresponding model for inference.
