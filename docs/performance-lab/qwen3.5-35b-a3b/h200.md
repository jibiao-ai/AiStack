...
| Performance Mode && Prefix Cache && Quantization                   | Total TPS: 10570.88 <span style="background-color:lightgreen;">(+9.75%)</span><br>Mean TPOT(ms): 24.71                                                               | Total TPS: 9632.01<br>Mean TPOT(ms): 25.89 |
| KV Cache Dtype && Performance Mode && Prefix Cache && Quantization | Total TPS: 10363.77 <span style="background-color:yellow;">(+7.60%,lower than previous +9.75%, optimization skipped in final command)</span><br>Mean TPOT(ms): 24.91 | Total TPS: 9632.01<br>Mean TPOT(ms): 25.89 |
