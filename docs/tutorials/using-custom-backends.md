...
This guide explains how to add custom inference backends in AiStack, including using verified community configurations and creating your own from scratch.
...
- **Built-in**: Pre-configured backends (vLLM, MindIE, VoxBox, SGLang...) maintained by AiStack, automatically optimized for different hardware.
