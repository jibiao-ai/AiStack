...
AiStack leverages Higress capabilities to provide Public MaaS integration. On the `Model` - `Provider` page, you can manage the integration of public model services.
...
Setting `http://192.168.50.14:8080/v1` makes AiStack look for `/v1/v1/models` and
