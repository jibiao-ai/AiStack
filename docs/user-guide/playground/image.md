...
The Image Playground is a dedicated space for testing and experimenting with AiStack’s image generation APIs. It allows users to interactively explore the capabilities of different models, customize parameters, and review code examples for seamless API integration.
...
You can select available models in AiStack by clicking the model dropdown at the top-right corner of the playground UI.
