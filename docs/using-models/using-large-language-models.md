...
In this guide, you will learn how to deploy and interact with LLMs in AiStack.
...
- AiStack installed and running. If not, refer to the [Quickstart Guide](../quickstart.md).
...
1. Navigate to the `Playground` > `Chat` page in the AiStack UI.
...
By following these steps, you can leverage LLMs for AI-powered text generation and natural language tasks in AiStack. Experiment with different prompts and settings to explore the full capabilities of LLMs!
