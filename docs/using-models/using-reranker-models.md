...
In this guide, we will demonstrate how to deploy and use reranker models in AiStack.
...
With the model deployed and an API key, you can rerank a list of documents via the AiStack API. Here is an example script using `curl`:
