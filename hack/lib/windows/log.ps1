...
function AiStack.Log.Errexit {
    trap {
        $ErrorMessage = $_.Exception.Message
        $ErrorCode = $_.Exception.HResult

        AiStack.Log.Panic -message $ErrorMessage -code $ErrorCode
        continue
    }
}

# Debug level logging.
function AiStack.Log.Debug {
    param (
