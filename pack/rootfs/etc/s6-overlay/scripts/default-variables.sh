...
# Following variables might be rewrited by config generated by AiStack
DATA_DIR="${DATA_DIR:-/var/lib/aistack}"
...
AISTACK_API_PORT=${AISTACK_API_PORT:-30080}
...
GF_SERVER_HTTP_PORT="${GF_SERVER_HTTP_PORT:-13000}"
GF_PATHS_DATA="${GF_PATHS_DATA:-${DATA_DIR}/grafana}"
GF_PATHS_LOGS="${GF_PATHS_LOGS:-${LOG_DIR}/grafana}"
