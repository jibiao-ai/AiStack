...
from aistack.logging import TRACE_LEVEL, trace
from aistack.schemas.principals import Principal, PrincipalType
from aistack.server import services
from aistack.server.services import UserService
...
def test_org_namespace_keys_off_name():
    ...
    assert get_namespace_name(principal_namespace_identifier(org)) == "aistack-acme"
...
def test_user_and_org_sharing_a_name_get_distinct_namespaces():
    ...
    assert user_ns == "aistack-user-5"
    assert org_ns == "aistack-acme"
