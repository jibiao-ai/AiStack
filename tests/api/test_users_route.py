"""Unit tests for :mod:`aistack.routes.users` covering the
...
import pytest
from aistack.api.exceptions import InternalServerErrorException, InvalidException
from aistack.routes import users as users_route
from aistack.schemas.users import AuthProviderEnum, UserCreate
