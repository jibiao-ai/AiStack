...
from aistack.cmd import reload_config
from aistack.cmd.reload_config import (
...
def test_reload_config_payload_only_contains_explicit_fields(monkeypatch, tmp_path):
    monkeypatch.setenv("AISTACK_DATA_DIR", str(tmp_path))
    monkeypatch.setenv("AISTACK_DEBUG", "true")
