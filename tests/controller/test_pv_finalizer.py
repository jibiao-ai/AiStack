...
from aistack.gpu_instances.controllers import GPUInstancePersistentVolumeController
...
def controller(engine, monkeypatch):
    monkeypatch.setattr(
        "aistack.gpu_instances.controllers.async_session",
