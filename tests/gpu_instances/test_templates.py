...
from aistack.gpu_instances import get_builtin_templates
from aistack.schemas.gpu_instance_templates import GPUInstanceSpecTemplate
...
async def test_no_builtin_template_disables_auth():
    # Regression guard for aistack/aistack#5757: a built-in template must
