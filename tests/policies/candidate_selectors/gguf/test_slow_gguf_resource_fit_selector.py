...
from aistack.scheduler.calculator import GPUOffloadEnum, _gguf_parser_command
...
async def test_schedule_with_deepseek_r1_bf16_end_in_multi_worker_multi_gpu_partial_offload(
    ...
    with (
        patch(
            'aistack.policies.utils.get_worker_model_instances',
            return_value=[],
        ),
        patch(
            'aistack.scheduler.calculator._gguf_parser_command',
            side_effect=mock_gguf_parser_command,
        ),
        patch(
            'aistack.scheduler.calculator.hf_model_filename',
            return_value="DeepSeek-R1-BF16/DeepSeek-R1.BF16-00001-of-00030.gguf",
        ),
        patch(
            'aistack.scheduler.calculator.hf_mmproj_filename',
            return_value=None,
        ),
        patch(
            'aistack.policies.scorers.placement_scorer.get_model_instances',
            return_value=[],
        ),
