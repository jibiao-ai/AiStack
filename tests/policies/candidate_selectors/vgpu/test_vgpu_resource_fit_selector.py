...
from aistack.policies.candidate_selectors import VGPUResourceFitSelector
...
_PATCH_SESSION = (
    "aistack.policies.candidate_selectors.vgpu_resource_fit_selector.async_session"
)
_PATCH_ALL_BY_FIELDS = (
    "aistack.policies.candidate_selectors.vgpu_resource_fit_selector."
