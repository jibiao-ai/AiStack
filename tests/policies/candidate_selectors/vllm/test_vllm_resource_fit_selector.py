...
from aistack.policies.utils import (
...
from aistack.policies.candidate_selectors import VLLMResourceFitSelector
...
async def test_lora_vram_claim_in_output_schedule_msg(config):
    ...
    with (
        patch(
            "aistack.policies.candidate_selectors.base_candidate_selector.get_pretrained_config_with_workers",
            new=AsyncMock(return_value=mock_pretrained),
        ),
        patch(
            "aistack.policies.utils.get_model_weight_size",
