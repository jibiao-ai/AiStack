import pytest
from aistack.routes.draft_models import get_draft_models
from aistack.routes.model_sets import filter_specs_by_gpu, get_model_sets
from aistack.schemas.common import ListParams
from aistack.schemas.gpu_devices import GPUDevice
from aistack.schemas.model_sets import (
    DraftModel,
    GPUFilters,
    ModelSetPublic,
    ModelSpec,
...
def stub_catalog(monkeypatch):
    ...
    monkeypatch.setattr(
        "aistack.routes.model_sets.list_catalog_model_sets", model_sets
    )
    monkeypatch.setattr(
        "aistack.routes.draft_models.get_catalog_draft_models", draft_models
    )
