...
from aistack.worker.logs import LogOptions
...
def _grafana_cfg(**overrides):
    fields = dict(
        ...
        grafana_cache_service_dashboard_uid="aistack-cache-service",
...
async def test_dashboard_redirects_to_grafana(monkeypatch):
    ...
    assert response.headers["location"] == (
        "http://server.example.com/grafana/d/aistack-cache-service"
        "/aistack-cache-service"
