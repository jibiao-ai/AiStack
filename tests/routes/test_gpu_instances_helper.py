"""Unit tests for :func:`aistack.routes.gpu_instances_helper.handle_error`.

The helper is the single translation point between the ``worker.aistack.ai/v1``
...
https://github.com/aistack/aistack/issues/6071: a write against a cluster with
...
from aistack.routes.gpu_instances_helper import handle_error
