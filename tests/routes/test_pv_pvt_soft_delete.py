...
from aistack.routes import gpu_instance_persistent_volumes as pv_routes
from aistack.routes import gpu_instance_persistent_volume_types as pvt_routes
...
async def session():
    ...
    # Mirror the app session (aistack.server.db): expire_on_commit=False is
