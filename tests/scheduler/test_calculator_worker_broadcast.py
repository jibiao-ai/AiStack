...
from aistack.scheduler.calculator import read_local_path_file_from_workers
...
async def test_read_local_path_file_from_workers_cancels_losers():
    ...
    with patch(
        "aistack.client.worker_filesystem_client.WorkerFilesystemClient.read_model_config",
