...
def make_event(
    *,
    ...
    snap = spec_snapshot or {
        ...
        "spec": {
            "type_": "aistack-nvidia-h100-c9bjn",
...
def test_open_window_extracts_sku_and_dims():
    ...
    assert w.sku == "aistack-nvidia-h100-c9bjn"
...
def test_resolve_sku_count():
    from aistack.server.resource_usage_collector import _resolve_sku_count
...
def _ue(**kw):
    base = dict(
        ...
        spec_snapshot={
            "name": "g1",
            "spec": {
                "type": "aistack-nvidia-geforce-rtx-5090-d-xpw9t",
...
async def test_reconcile_seeds_open_window(events_session):
    ...
    assert w.sku == "aistack-nvidia-geforce-rtx-5090-d-xpw9t"
...
async def events_and_metered_session():
    ...
    from aistack.schemas.metered_usage import MeteredUsage
