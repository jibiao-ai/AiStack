...
from aistack.schemas.catalog_source import CatalogSource, normalize_catalog_yaml
from aistack.schemas.inference_backend_source import InferenceBackendSource
from aistack.schemas.runner_source import InferenceRunnerSource
from aistack.server.sources import probe
from aistack.server.sources import routes as sources_routes
from aistack.schemas.source import SourceTypeEnum
from aistack.server.sources.core import OFFICIAL_SOURCE_NAME, sha256_of
from aistack.server.sources.probe import OFFICIAL_DEFAULT_HOURS, refresh_sources
...
class FakeMirror:
    ...
    def __init__(self):
        self.refs = {"aistack/aistack": "v1", "aistack/runner": "v1"}
        self.repos = {
            _CATALOG_FILE: "aistack/aistack",
            _BACKEND_FILE: "aistack/aistack",
            _RUNNER_FILE: "aistack/runner",
        }
        self.files = {
...
async def test_a_round_applies_each_slot_then_returns_early_at_two_levels(
    ...
    mirror.refs["aistack/aistack"] = "v2"
