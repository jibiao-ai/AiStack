...
def test_cleanup_keeps_workloads_of_this_workers_instances():
    ...
    with (
        patch(
            "aistack.worker.workload_cleaner.list_workloads",
            return_value=workloads,
        ),
        patch("aistack.worker.workload_cleaner.delete_workload") as delete,
    ):
...
def test_cleanup_spares_recent_cache_service_workloads():
    ...
    with (
        ...
        patch(
            "aistack.worker.workload_cleaner.network.is_offline",
